...
- (UICollectionViewFlowLayout *)segmentBarLayout
{
    ...
    segmentBarLayout.sectionInset = UIEdgeInsetsZero;
...
- (DDPageBar *)pageBar
{
    return _pageBar = ({
        ...
        if (_pageBar) {
            ...
            bar = [[DDPageBar alloc] initWithFrame:CGRectMake(0, 0, CGRectGetHeight(self.view.frame), 44) collectionViewLayout:[self segmentBarLayout]];
            bar.delegate = self;
        }
        bar;
    });
...
- (UIView *)indicatorLayer
{
    return _indicatorLayer = ({
        ...
        if (_indicatorLayer) {
            ...
            CGRect frame = CGRectMake(5, _contentView.dd_height, self.view.dd_width / _controllers.count - 10, INDICATOR_HEIGHT);
            layer = [[UIView alloc] initWithFrame:frame];
